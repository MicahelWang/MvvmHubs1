...
namespace Hubs1.Core.Utils
{
    ...
    public static class JsonHelper
    {
        ...
        public static string SerializeObject(object o, JsonSerializerSettings setting)
        {
            string json = JsonConvert.SerializeObject(o, setting);
            return json;
        }
        ...
        public static string ToJson(this object o)
        {
            ...
            return SerializeObject(o, setting);
        }
